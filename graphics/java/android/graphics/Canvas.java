...
public class Canvas {
    ...
    */
    ...
    private native void native_drawString(String text, float x, float y, Paint paint);
    ...
    public void drawText(CharSequence text, int start, int end, float x,
        ...
        if (text instanceof String || text instanceof SpannedString ||
            ...
            FriBidi f = new FriBidi(text.toString());
            f.reorder(start, end - start);
            native_drawText(mNativeCanvas, f.str, start, end, x, y,
                            paint.mNativePaint);
        }
